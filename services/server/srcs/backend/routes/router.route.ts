...
const validRoutes = ['home', 'about',  'update_profile', 'login', 'options', 'register', 'dashboard', 'users', 'game', 'lobby', 'chat', 'new_lobby', 'local-game', 'tournament_select', 'tournament_tree', 'tournament_match']
